...
def zoom_regions(clicks, vid, level, dur, gap=2.5, pre=0.45, post=1.0, ramp=0.55,
                 level_cap=2.6, text_cap=3.0, keys=None, moves=None, click_bbox=None, key_bbox=None):
                 # text_cap was 6.5 — legible but dead-tight (loses all context); 3.0 keeps the typed
                 # field readable AND in context, which reads far better in a demo (auto-output looked over-zoomed)
