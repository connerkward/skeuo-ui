...
export const skinList: SkinAssets[] = [
  ...
  // SpongeBob villain — manta-ray head, wide visualizer, lightning-bolt scrub,
  // shuffle · play · next. Borrows the WMP aqua palette/sprites (cyan suits the
  // Man Ray emblem). Generated by `wild_sculpt.py manray manray … manray`.
  { id: "manray",  name: "Man Ray ✦",      blurb: "SpongeBob villain: manta-ray head, lightning scrub", has: ["frame"], live: true, style: "wmp", templateUrl: "/skins/manray/template.json" },
