...
BODY = (
    ...
    "lower half — both LARGE CLEAN RECTANGLES with crisp straight edges (slightly rounded corners), flat "
    "COMPLETELY EMPTY switched-off near-black glass; the body material frames the screens but NEVER "
    "grows over or intrudes onto the glass. Plus EMPTY RECESSED MOUNTING WELLS (bare dark sockets, NOTHING mounted "
