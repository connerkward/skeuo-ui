#!/usr/bin/env python3
"""B-proof runner via Vertex AI (fal balance exhausted; same underlying model
`gemini-3-pro-image-preview` served by Google directly, same seed/resolution).
See run_bproof.py docstring for the experimental design.
"""
