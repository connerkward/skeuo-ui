...
def main():
    ...
    prompt = (
        ...
        "the empty wells — neutral DARK recesses only. If ANY of the three cavities (knob socket, seek groove, "
        ...
        "they differ ONLY by the LEVER/PUCK POSITION (slid to one end vs the other). Put ABSOLUTELY NO 'ON', 'OFF', "
        "'I', 'O' or any text/letters/words/labels on either switch part or on ANY strip part — no engraved or "
        "printed words anywhere on the loose parts; the state reads from lever position alone.\n"
