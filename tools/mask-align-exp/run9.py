...
PROMPT=("Two side-by-side columns of identical size. LEFT column: a BLUEPRINT of an early-2000s candybar "
  ...
  "The BOTTOM BAND of the left column is a SPRITE STRIP with the loose PARTS to manufacture. The strip has "
  "EXACTLY FIVE cells, left to right, each holding ONE specific part: "
  "(1) GREEN circle = the VOLUME knob cap — a ROUND knob cap; "
  "(2) CYAN circle = the BALANCE knob cap — a ROUND knob cap, same design; "
  "(3) ORANGE wide pill outline = the SEEK SLIDER THUMB — a small WIDE pill-shaped grip handle, clearly WIDER "
  "than it is tall, the loose grip that rides the horizontal seek groove; it is NOT a switch, NOT a toggle, "
  "NOT tall, and has NO frame or slot around it; "
  "(4) PINK tall outline = the TOGGLE SWITCH part in its OFF position — a TALL rounded-rectangle switch, "
  "clearly TALLER than it is wide; "
  "(5) PINK tall outline = the SAME toggle switch part in its ON position (lever flipped). "
  "Each cell's part must match the guide outline drawn in that cell: a ROUND outline gets a ROUND part, a "
  "WIDE pill outline gets a WIDE pill part, a TALL outline gets a TALL switch — NEVER swap cell contents, "
  "NEVER paint a toggle switch where the wide pill outline is. RIGHT column: pure black.\n"
  ...
  "duplicate the parts, do NOT repeat), left to right, honouring the per-cell identities above: (1) volume "
  "knob cap ROUND, (2) balance knob cap ROUND, (3) seek slider thumb — a WIDE LOW pill grip, wider than tall, "
  "NOT a switch, (4) toggle switch OFF — TALL, (5) toggle switch ON — TALL. All five are finished "
  f"graphite-and-chrome parts on the flat {BD_LOW} backdrop, outlines removed, uncoloured.\n"
  "  • STRIP ZERO RESIDUE — every strip part is a finished PRODUCT PHOTO of the bare part alone on the "
  "backdrop. NO coloured outline, ring, rim, halo, frame, border or tint of the guide colour may remain "
  "ANYWHERE on or around ANY strip part — not encircling the part, not underneath it, not as a faint "
  "washed-out ring. The coloured guide outline in each strip cell is a POSITIONING MARK ONLY: paint it "
  "completely away, leaving only the backdrop and the part's own graphite/chrome material. A pink ring "
  "around a toggle, an orange rim around the thumb, or a green/cyan ring around a knob cap = WRONG output.\n"
