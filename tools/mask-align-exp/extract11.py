...
template geometry come from assets11/results.json (written by run10.py) — ZERO hardcoded
...
OUT = os.path.join(os.path.dirname(__file__), "assets11")
...
_mp = os.path.join(os.path.dirname(__file__), "assets11_biref", "global-matte.png")
